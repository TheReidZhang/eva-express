...
const schema = z.object({
  ...
  DB_SSL: z.enum(BooleanType).default('false').transform((val) => val === 'true'),
  RUNNING_SCRIPT: z.enum(BooleanType).default('false').transform((val) => val === 'true'),
  TYPEORM_CLI: z.enum(BooleanType).default('false').transform((val) => val === 'true'),
